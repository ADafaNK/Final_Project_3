...
<body>
    <div class="atas">
        ...
        <div class="s1"><br><br><br>
            <a href="<?php echo base_url(); ?>admin/tambah/" class="btn-btn-primary">Tambah</a>
            <div class="dp1">
                <table class="table-table-primary">
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <a style="float: left; background: #b02a37; color: #fff;" href="<?php echo base_url(); ?>admin/hapus/<?php echo $row->id; ?>" class="btn btn-danger">Hapus</a>
                                <a style="float: left; background: #ffc107; color: #fff;" href="<?php echo base_url(); ?>admin/edit/<?php echo $row->id; ?>" class="btn btn-warning">Edit</a>
                            </td>
                        </tr>
                    <?php
                    }
