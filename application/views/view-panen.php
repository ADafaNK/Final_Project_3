                ...
                <table class="table-table-primary">
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <a style="float: left; background: #b02a37; color: #fff;" href="<?php echo base_url(); ?>hasilpanen/hapus/<?php echo $row->id; ?>" class="btn btn-danger">Hapus</a>
                                <a style="float: left; background: #ffc107; color: #fff;" href="<?php echo base_url(); ?>hasilpanen/edit/<?php echo $row->id; ?>" class="btn btn-warning">Edit</a>
                            </td>
                        </tr>
                    <?php
                    }
